  ...
  return (function () {
    ...
    class K {
        ...
        if (
          ...
          N(this, 'update', (e) => {
            ...
            this._createMinMaxDates(),
              ...
              !t.isMobile && h
                ? (this.treatAsInline || P || this._createMobileOverlay(), this._addMobileAttributes(), this.visible && this._showMobileOverlay())
                : t.isMobile && !h && (this._removeMobileAttributes(), this.visible && (P.classList.remove('-active-'), 'function' != typeof this.opts.position && this.setPosition())),
      ...
      init() {
        ...
        var o;
        B || i || !this.elIsInput || ((B = !0), (R = n({ className: (o = K.defaultContainerId), id: o })), I.appendChild(R)),
      ...
      _addButtons() {
        (this.$buttons = n({ className: 'air-datepicker--buttons' })), this.$datepicker.appendChild(this.$buttons), (this.buttons = new x({ dp: this, opts: this.opts })), this.$buttons.appendChild(this.buttons.$el);
      }
      _bindSubEvents() {
      ...
      unselectDate(e) {
        ...
        if ((e = b(e)) instanceof Date)
          return t.some((a, n) => {
            if (u(a, e))
              return (
                t.splice(n, 1), s.selectedDates.length ? s._updateLastSelectedDate(s.selectedDates[s.selectedDates.length - 1]) : ((s.rangeDateFrom = ''), (s.rangeDateTo = ''), s._updateLastSelectedDate(!1)), this.trigger(i.eventChangeSelectedDate, { action: i.actionUnselectDate, date: e }), !0
              );
          });
      }
      replaceDate(e, t) {
    ...
    var j;
    return N(K, 'defaults', s), N(K, 'version', '3.2.1'), N(K, 'defaultContainerId', 'air-datepicker-global-container'), (j = K.prototype), Object.assign(j, E), t.default;
  })();
});
